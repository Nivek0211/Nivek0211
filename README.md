...
### [FieldSense: Plataforma IoT & Full-Stack](https://hadwareysoftwarefullstack.netlify.app/)
...
*   Resolución de bloqueos de comunicación en servicios de túneles mediante la inyección directa de cabeceras HTTP personalizadas (`ngrok-skip-browser-warning`, `Bypass-Tunnel-Reminder`) en la configuración del servidor.

### [Sitio Web Comercial: Exhibimuebles Valsequillo](https://exhibimuebles-valsequillo.netlify.app/)
*   Desarrollo y despliegue de una solución web a medida para el sector comercial, gestionando el ciclo de vida completo del proyecto hasta su implementación en producción.
*   Ingeniería de un catálogo interactivo utilizando **JavaScript Vanilla**, optimizando la manipulación del DOM para ejecutar un sistema de filtrado asíncrono, fluido y sin latencia de recarga.

### [VelociMath: Concepto de Aplicación Educativa]
*   Diseño integral de la interfaz y conceptualización de una aplicación móvil orientada al aprendizaje matemático.
*   Implementación de una temática visual inmersiva y gamificada (basada en velociraptors) para mejorar la retención y experiencia de usuario.

### [Plataforma Web Estática: Análisis Discográfico Temático](https://tecjojianalisis.netlify.app/)
*   Desarrollo de una plataforma web dedicada a la exploración artística y discográfica.
...
*   **Enfoque y Especialización:** Resultados realistas y directos. Me dedico a enfocar mis fortalezas de programación para tomar requerimientos complejos y convertirlos en software funcional de alto impacto.
